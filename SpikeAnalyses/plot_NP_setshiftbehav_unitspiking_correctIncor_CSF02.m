function plot_NP_setshiftbehav_unitspiking_correctIncor_CSF02
...
for rt = 1:1  % we can't do rt =2 yet as of now because the spike files did not include the entire recording time
    ...
    if rt == 1
        ...
        data(2).unitfilepath2 = ...
            'Z:\projmon\ericsprojects\Setshift\EPHYSDATA\NP\CSF02\2021-09-24_15-17-10\SpikesFrom2ndProbe_09242021';
        data(2).path = ...
        ...
        data(2).logfn = 'Z:\projmon\ericsprojects\Setshift\EPHYSDATA\NP\CSF02\2021-09-24_15-17-10\CSF02_2021_09_24__15_17_02.csv';
    ...
    for reg = 2:2
        ...
        for dy = 2:2
            ...
            if rt == 1
                ...
                elseif reg == 2
                    figpath = 'z:\projmon\ericsprojects\Setshift\ANALYSES\NP spike analyses\CSF02_ST';
...
ylabel('Spike rate','FontSize',70,'Position',[-1.5,0.05,-1]);
...
set(gca, 'FontName', 'Arial', 'FontSize', 50, 'FontWeight', 'bold')
ylabel('Spike rate','FontSize',80,'Position',[-5,0.15,-1]);
xlabel('Unit IDs','FontSize',80)
xlim([0,55])
legend('Correct trials','Incorrect trials')
box off
...
ylabel('Spike rate','FontSize',80,'Position',[-7.5,0.15,-1])
xlabel('Unit IDs','FontSize',65)
legend('Correct trials','Incorrect trials','FontSize',50)
box off
legend boxoff 
