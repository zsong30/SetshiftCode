function plot_NP_setshiftbehav_unitspiking_correctIncor_CSF03
    ...
    elseif rt == 2  % we can't do rt =2 yet as of now because the spike files did not include the entire recording time
        ...
        data(3).path = ...
           "Z:\projmon\ericsprojects\Setshift\EPHYSDATA\NP\CSF03\CSF03_2022-03-31_14-46-54\Record Node 102\experiment1\recording1\structure.oebin";
                data(3).unitfilepath = ...
            "Z:\projmon\ericsprojects\Setshift\EPHYSDATA\NP\CSF03\CSF03_2022-03-31_14-46-54\CSF03SpikesFrom1stProbe_03312022.mat";
        data(3).logfn = ...
    ...
    for reg = 1:1
        ...
        for dy = 3:3
            ...
            if rt == 1
                ...
                elseif reg == 2
                    figpath = '\\rds01.storage.umn.edu\hst_widge\projmon\ericsprojects\Setshift\ANALYSES\NP spike analyses\CSF02_ST';
...
ylabel('Spike rate','FontSize',80,'Position',[-7,1.25,-1])
...
set(gca, 'FontName', 'Arial', 'FontSize', 50, 'FontWeight', 'bold')
ylabel('Spike rate','FontSize',80,'Position',[-0.35,0.6,1])
xlabel('Unit IDs','FontSize',80)
xlim([0,size(unitIncorrectData,2)+1])
legend('Correct trials','Incorrect trials')
box off
...
ylabel('Spike rate','FontSize',90,'Position',[-6.5,1.25,-1])
xlabel('Unit IDs','FontSize',65)
xlim([0,size(spikerate_correct_aver,2)+1])
