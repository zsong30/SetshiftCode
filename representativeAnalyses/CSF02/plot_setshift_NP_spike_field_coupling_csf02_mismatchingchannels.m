    function plot_setshift_NP_spike_field_coupling_csf02_mismatchingchannels
...
channels2include = 1:4:384;
    ...
    figname1 = ...
        sprintf('%s-%s-%s-frqband %d-%d %d units ISI %d-%d %s unit%dmismatched',ratname,datadate,regionname,frq(i).band(1),frq(i).band(2),length(unit2plot),ISIsLowerLimit,ISIsUpLimit,plotname,unit2plot(u));
