    function plot_setshift_NP_spike_field_coupling_csf02_crossregional3
...
channels2include = 3:4:384;
    ...
    figname1 = ...
        sprintf('%s-%s-%s-frqband %d-%d %d units ISI %d-%d %s unit%d_crossregional3',ratname,datadate,regionname,frq(i).band(1),frq(i).band(2),length(unit2plot),ISIsLowerLimit,ISIsUpLimit,plotname,unit2plot(u));
