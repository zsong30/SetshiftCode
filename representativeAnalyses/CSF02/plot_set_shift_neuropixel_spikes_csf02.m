function plot_set_shift_neuropixel_spikes_csf02

% Author: Eric Song

% figpath = 'Z:\projmon\ericsprojects\Setshift\ANALYSES\representative analyses\unittraits\CSF02_PL';
% % figpath = 'Z:\projmon\ericsprojects\Setshift\ANALYSES\representative analyses\unittraits\CSF02_ST';
% figpath = 'Z:\projmon\ericsprojects\Setshift\ANALYSES\representative analyses\unittraits\CSF02_PL\CSF02_PL_09232021';
figpath = 'Z:\projmon\ericsprojects\Setshift\ANALYSES\representative analyses\unittraits\CSF02\CSF02_PL_09222021';

% datafile = 'Z:\projmon\ericsprojects\NP_manuscript\Data\SpikeyieldsData\trimmedData\CSF02SpikesFrom1stProbe_09242021_trimmed';
% datafile = 'Z:\projmon\ericsprojects\Setshift\EPHYSDATA\NP\CSF02\2021-09-24_15-17-10\CSF02SpikesFrom2ndProbe_09242021';
% datafile = 'Z:\projmon\ericsprojects\Setshift\EPHYSDATA\NP\CSF02\2021-09-23_14-50-18\CSF02SpikesFrom1stProbe_09232021_trimmed.mat';
...
%         data = normalize((trial(tr).units(units2plot(u)).spikeData -median(trial(tr).units(units2plot(u)).spikeData,2))'*0.195,'zscore'); %z-scored voltage
        data = (trial(tr).units(units2plot(u)).spikeData -median(trial(tr).units(units2plot(u)).spikeData,2))'*0.195;
        plot(t,data,'Color',[0.5 0.5 0.5])
        hold on
        plot(t,median(data,2,'omitnan'),'LineWidth',3,'Color','r')
        xlabel('Time (ms)', 'FontWeight', 'bold')
%         ylabel('Z-scored Voltage', 'FontWeight', 'bold'); % y-label for when using z-scored voltage
