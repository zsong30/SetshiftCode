function plot_set_shift_neuropixel_spikes_csf04

% Author: Eric Song
% Commented by: Jack Major 06/23
%%% This script outputs 3 different figures: %%%
% 1) shows a sample of spike waveforms from a single probe
% 2) makes a  figure with 3 subplots:
%       i)  shows the spike waveform in units of z-scored voltage for all spikes from that recording overlaid on each other, with the average waveform shown
%      ii)  histogram of spike counts by inter-spike interval (time between two spikes)
%     iii)  histogram with time on the x-axis and autocorrelation on the y-axis (Still confused about this one)
% 3) generates a rasterplot of a sample of individual units (neurons) and their spiking pattern over a 100 second interval


%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%


% figpath sets the path where the figures generated by this script will be saved 
% figpath = 'Z:\projmon\ericsprojects\Setshift\ANALYSES\representative analyses\unittraits\plot_set_shift_neuropixel_spikes\CSF04\CSF04_ST_10122022';
figpath = 'Z:\projmon\ericsprojects\Setshift\ANALYSES\representative analyses\unittraits\plot_set_shift_neuropixel_spikes\CSF04\CSF04_ST_10132022';
% figpath = 'Z:\projmon\ericsprojects\Setshift\ANALYSES\representative analyses\unittraits\plot_set_shift_neuropixel_spikes\CSF04\CSF04_ST_10142022'; 

% datafile sets the path where the script will obtain data to be used
% the spike data, which is used for this script, is generated using do_set_shift_neuropixel_spikes_one_file_only
% datafile = "Z:\projmon\ericsprojects\Setshift\EPHYSDATA\NP\CSF04\2022-10-12_13-00-28\CSF04SpikesFrom2ndProbe_10122022";
datafile = "Z:\projmon\ericsprojects\Setshift\EPHYSDATA\NP\CSF04\2022-10-13_14-48-21\CSF04SpikesFrom2ndProbe_10132022";
% datafile = "Z:\projmon\ericsprojects\Setshift\EPHYSDATA\NP\CSF04\2022-10-14_15-11-41\CSF04SpikesFrom2ndProbe_10142022";
load(datafile,'trial')
