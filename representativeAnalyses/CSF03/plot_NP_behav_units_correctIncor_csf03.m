function plot_NP_behav_units_correctIncor_csf03
...
for rt = 1:1  % we can't do rt =2 yet as of now because the spike files did not include the entire recording time
    ...
    if rt == 1 % rt == 1 is CSF03, PL
        ...
        data(1).unitfilepath = ...
            "Z:\projmon\ericsprojects\Setshift\EPHYSDATA\NP\CSF03\CSF03_2022-03-29_14-52-47\CSF03SpikesFrom1stProbe_03292022";
        data(1).unitfilepath2 = ...
            "Z:\projmon\ericsprojects\Setshift\EPHYSDATA\NP\CSF03\CSF03_2022-03-29_14-52-47\CSF03SpikesFrom2ndProbe1min_03292022";   
        data(1).logfn = ...
            "Z:\projmon\ericsprojects\Setshift\EPHYSDATA\NP\CSF03\CSF03_2022-03-29_14-52-47\CSF03PM_2022_03_29__14_52_00";
%         data(1).ratname = 'CSF02';
%         data(1).datadate = '09232021';
        ...
        data(2).unitfilepath = ...
            "Z:projmon\ericsprojects\Setshift\EPHYSDATA\NP\CSF03\CSF03_2022-03-30_15-02-57\CSF03SpikesFrom1stProbe1min_03302022";
        data(2).unitfilepath2 = ...
            "Z:\projmon\ericsprojects\Setshift\EPHYSDATA\NP\CSF03\CSF03_2022-03-30_15-02-57\SpikesFrom2ndProbe1min_03302022"; 
        data(2).3014-11961--UMSPR-00076723-1----- = "Z:\projmon\ericsprojects\Setshift\EPHYSDATA\NP\CSF03\CSF03_2022-03-30_15-02-57\CSF03_2022_03_30__15_03_00";
        ...
        data(3).unitfilepath2 = ...
            "Z:\projmon\ericsprojects\Setshift\EPHYSDATA\NP\CSF03\CSF03_2022-03-31_14-46-54\SpikesFrom2ndProbe1min_03312022"; 
        data(3).logfn = "Z:\projmon\ericsprojects\Setshift\EPHYSDATA\NP\CSF03\CSF03_2022-03-31_14-46-54\CSF03_2022_03_31__14_47_00";
    ...
    for reg = 1:1
        ...
        for dy = 3:3
            ...
            if rt == 1
                if reg == 1
%                     figpath = 'Z:\projmon\ericsprojects\Setshift\ANALYSES\representative analyses\unit-behavior-correlation\plot_NP_behav_units_correctIncor_csf03\CSF03\CSF03_PL_03292022';
%                     figpath = 'Z:\projmon\ericsprojects\Setshift\ANALYSES\representative analyses\unit-behavior-correlation\plot_NP_behav_units_correctIncor_csf03\CSF03\CSF03_PL_03302022';
                    figpath = 'Z:\projmon\ericsprojects\Setshift\ANALYSES\representative analyses\unit-behavior-correlation\plot_NP_behav_units_correctIncor_csf03\CSF03\CSF03_PL_03312022';
                ...
                elseif reg == 2
                    figpath = 'Z:\projmon\ericsprojects\Setshift\ANALYSES\csf02representativeAnalyses\unit-behavior-correlation\CSF02_ST';
            ...
            elseif rt == 2
                if reg == 1
                    figpath = 'Z:\projmon\ericsprojects\Setshift\ANALYSES\NP spike analyses\CSF03_PL';
