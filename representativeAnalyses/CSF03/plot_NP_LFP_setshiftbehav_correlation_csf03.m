function rat = plot_NP_LFP_setshiftbehav_correlation_csf03
...
params.trialave = 0;
movingwin = [0.5 0.01];
datapath = 'Z:\projmon\ericsprojects\Setshift\DATA\representative analyses\CSF03';
...
for rt = 1:1
    ...
    for reg = 1:1
        ...
        for dy = 3:3
            ...
            if rt == 1
                if reg == 1
%                     figpath = 'Z:\projmon\ericsprojects\Setshift\ANALYSES\representative analyses\lfp-behavior-correlation\plot_NP_LFP_setshiftbehav_correlation\CSF03\CSF03_PL_03292022';
%                      figpath = 'Z:\projmon\ericsprojects\Setshift\ANALYSES\representative analyses\lfp-behavior-correlation\plot_NP_LFP_setshiftbehav_correlation\CSF03\CSF03_PL_03302022';
                      figpath = 'Z:\projmon\ericsprojects\Setshift\ANALYSES\representative analyses\lfp-behavior-correlation\plot_NP_LFP_setshiftbehav_correlation\CSF03\CSF03_PL_03312022';
