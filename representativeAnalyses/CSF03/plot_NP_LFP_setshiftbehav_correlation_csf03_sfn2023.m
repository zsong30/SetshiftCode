function rat = plot_NP_LFP_setshiftbehav_correlation_csf03_sfn2023
...
params.trialave = 0;
movingwin = [0.5 0.01];
datapath = 'Z:\projmon\ericsprojects\Setshift\DATA\representative analyses\CSF03\CSF03_sfn2023';
% datapath = 'Z:\projmon\ericsprojects\Conferences\sfn2023';
...
for rt = 1:1
    ...
    if rt == 1 % rt == 1 is CSF03, PL
        ...
        data(2).logfn = "Z:\projmon\ericsprojects\Setshift\EPHYSDATA\NP\CSF03\CSF03_2022-03-30_15-02-57\CSF03_2022_03_30__15_03_00.csv";
        ...
        data(3).logfn = ...
            "Z:\projmon\ericsprojects\Setshift\EPHYSDATA\NP\CSF03\CSF03_2022-03-31_14-46-54\CSF03_2022_03_31__14_47_00";
    ...
    for reg = 1:1
        ...
        for dy = 1:1
            ...
            if rt == 1
                if reg == 1
                     figpath = 'Z:\projmon\ericsprojects\Setshift\ANALYSES\representative analyses\lfp-behavior-correlation\plot_NP_LFP_setshiftbehav_correlation\CSF03\CSF03_PL_03292022_sfn2023';
%                      figpath = 'Z:\projmon\ericsprojects\Setshift\ANALYSES\representative analyses\lfp-behavior-correlation\plot_NP_LFP_setshiftbehav_correlation\CSF03\CSF03_PL_03302022';
%                      figpath = 'Z:\projmon\ericsprojects\Setshift\ANALYSES\representative analyses\lfp-behavior-correlation\plot_NP_LFP_setshiftbehav_correlation\CSF03\CSF03_PL_03312022_sfn2023';
            ...
            elseif rt == 2
                if reg == 1
                    figpath = 'Z:\projmon\ericsprojects\Setshift\ANALYSES\representative analyses\lfp-behavior-correlation\CSF03_PL\CSF03_PL_03292022';
                    RawData = load_open_ephys_binary(data(dy).path, 'continuous',2,'mmap');
                elseif reg == 2
...
%             incorrectdata = day(2).incorrectdata; %for day2
...
%             f1 = figure('name',sprintf( 'CSF02-092421-PL-Power specgram heatmap cluster#%d',i));
%            f1 = figure('name',sprintf( 'CSF03-03312022-PL-Power specgram heatmap cluster#%d',i));
               f1 = figure('name',sprintf( 'CSF03-03292022-PL-Power specgram heatmap cluster#%d',i));
            ...
            pcolor(t,f, normS'); colormap('hot'); shading flat
            hold on
            xlabel('Time(sec)'); ylabel('Frequency (Hz)');
            axis xy;
            c = colorbar;
            c.Ticks = [-5,-2.5,0,2.5,5];
            clim([-5 5]); %colorbar('eastoutside');
            ylim(params.fpass);
            ...
            pcolor(t,f, normS2'); colormap('hot'); shading flat
            xlabel('Time(sec)'); ylabel('Frequency (Hz)');
            axis xy;
            clim([-5 5]); 
            c = colorbar;
            ...
            pcolor(t,f, S4'); 
            colormap;
            colormap(sub3,'bipolar'); shading flat
    ...
    fname2save = sprintf('CSF03_%s.mat',datestr(now,30)); %#ok<*TNOW1,*DATST>
