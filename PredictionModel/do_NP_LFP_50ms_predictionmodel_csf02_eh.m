...
%                     figpath = 'Z:\projmon\ericsprojects\Setshift\ANALYSES\representative analyses\lfp-behavior-correlation\CSF02\CSF02_PL_09232021';
            ...
            for i=1:3
                ...
                adjustedRT = cleandatacorrect.time{1,i}(end) - 1.02; % cleandatacorrect.time{1,i}(end) is the end of the learning period. We know this will always be 1.25 seconds after the response time.
                foundIndex = 0;
                for z=1:length(tim)
            ...
            % incorrectSegments = [round(incorrectInitiationT*2500)-625;round(incorrectResponseT*2500) + 3125]';
             incorrectSegments = [round(incorrectInitiationT*2500)-62;round(incorrectResponseT*2500) + 2562]';
            ...
            incorrectlnsegments = [round(incorrectResponseT * 2500)-62;round(incorrectResponseT * 2500) + 2562]';
            ...
            for i=1:3
                ...
                adjustedRT = cleandataincorrect.time{1,i}(end) - 1.02; % cleandataincorrect.time{1,i}(end) is the end of the learning period. We know this will always be 1.25 seconds after the response time.
                foundIndex = 0;
