function clean_data = get_clean_data_automatic_ES(data,timestamps,segments)
...
% define fsample
region2data.fsample = 1500;
region1data.fsample = 1500;
...
clean_data = ft_appenddata(cfg,region1data_redefine,region2data_redefine);  % combine IL and BLA data
