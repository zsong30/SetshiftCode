...
fig = figure;
 subplot(1,2,1)
    hp5 = plot(f,Mn_S1_ddd','LineWidth',3,'Color','g');
    hold on
    patch([f,fliplr(f)], [(Mn_S1_ddd-SEM_S1_ddd)',flipud(Mn_S1_ddd+SEM_S1_ddd)'],'g','EdgeColor','none', 'FaceAlpha',0.2)
    hp6 = plot(f,Mn_S2_ddd','LineWidth',3,'Color','b');
    patch([f,fliplr(f)], [(Mn_S2_ddd-SEM_S2_ddd)',flipud(Mn_S2_ddd+SEM_S2_ddd)'],'b','EdgeColor','none', 'FaceAlpha',0.2)
    
      hp7 = plot(f,Mn_S2_b_ddd','LineWidth',3,'Color','b','LineStyle',':');
      patch([f,fliplr(f)], [(Mn_S2_b_ddd-SEM_S2_b_ddd)',flipud(Mn_S2_b_ddd+SEM_S2_b_ddd)'],'b','EdgeColor','none', 'FaceAlpha',0.2)
...
title('Coherence_((SideCorrect-SideIncorrect)-(Rear-Front))','interpreter', 'none')
    ...
    figname = 'doubleContrast1.fig';
    figname2 = 'doubleContrast1.png';
