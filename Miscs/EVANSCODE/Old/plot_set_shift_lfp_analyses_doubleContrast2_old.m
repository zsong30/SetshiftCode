function plot_set_shift_lfp_analyses_doubleContrast2(rat,plotnum)
% plot_set_shift_lfp_analyses_doubleContrast2(rat,1)
...
tmp = [];
for comparison = 5:5 % loop in all comparisons; 6 is hard coded, but can be any number.
...
title('Coherence_((SideCorrect-SideIncorrect)-(Rear-Front))','interpreter', 'none')
    ...
    figpath = 'G:\My Drive\Setshift\figures_doublecontrast2';
