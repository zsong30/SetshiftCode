function rat = do_set_shift_NP_lfp_incomplete_sessions
...
rat(2).name = 'CSF03'; rat(2).sex = 'female';
...
rat(2).day(1).bpath = ...
    'E:\SetShift\EPHYSDATA\NP\CSF03\CSF03_2022-03-29_14-52-47';
rat(2).day(1).logfn = ...
    'CSF03PM_2022_03_29__14_52_00';

rat(2).day(2).epath = ...
    'E:\SetShift\EPHYSDATA\NP\CSF03\CSF03_2022-03-30_15-02-57\Record Node 102\experiment1\recording1\structure.oebin';
rat(2).day(2).bpath = ...
    'E:\SetShift\EPHYSDATA\NP\CSF03\CSF03_2022-03-30_15-02-57';
rat(2).day(2).logfn = ...
    'CSF03_2022_03_30__15_03_00';

rat(2).day(3).epath = ...
    'E:\SetShift\EPHYSDATA\NP\CSF03\CSF03_2022-03-31_14-46-54\Record Node 102\experiment1\recording1\structure.oebin';
rat(2).day(3).bpath = ...
    'E:\SetShift\EPHYSDATA\NP\CSF03\CSF03_2022-03-31_14-46-54';
rat(2).day(3).logfn = ...
    'CSF03_2022_03_31__14_47_00';
...
for rt = 1:length(rat)
    ...
    for dy = 1:length(rat(rt).day)
        ...
        setshift = read_set_shift_behavior_one_file_only_imcomplete_session(logfn);
...
save('CSF02threeDaysCSF03threeDaysSetshift.mat','rat','-v7.3')
