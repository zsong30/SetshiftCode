function plot_set_shift_spikes_with_task
...
figpath = 'Z:\projmon\ericsprojects\NP_manuscript';
        ...
        data(1).unitfilepath = ...
            'Z:\projmon\ericsprojects\Setshift\EPHYSDATA\NP\CSF02\2021-09-22_09-53-40\CSF02SpikesFrom1stProbe_09222021_trimmed';
        ...
        data(3).unitfilepath2 = ...
            'E:\SetShift\EPHYSDATA\NP\CSF02\2021-09-24_15-17-10\CSF02SpikesFrom2ndProbe_09242021';
        data(3).path = ...
...
pi_unit2plot_unitindx = [36,72]; % for 23rd
pt_unit2plot_unitindx = [5,52,55]; % for 23rd
...
fig8 = figure('name',sprintf('Single_unit_interval_prone_spiking_unit%d',units2plot(u)));
hold on
...
fig9 = figure('name',sprintf('Single_unit_task_prone_spiking_unit%d',units2plot(v)));
hold on
...
unitgroupA = a;
unitgroupB = b;
for channelnum = 1:length(unitgroupA)
ChanngroupA(channelnum) = trial.units(unitgroupA(channelnum)).channel;
end

for channelnumB = 1:length(unitgroupB)
ChanngroupB(channelnumB) = trial.units(unitgroupB(channelnumB)).channel;
end
